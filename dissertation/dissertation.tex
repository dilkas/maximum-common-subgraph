...
% TODO: could define graph colouring
...
% TODO: define algorithm portfolio
...
\ref{fig:ecdf_unlabelled_sip}. We also provide a heatmap in Figure
...
% TODO: when making a mistake, what is confused for what?
...
% TODO: define tree, root, observation, node, child, class, split
...
\begin{definition} % TODO: explain using pictures and examples?
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[scale=0.7]{images/unlabelled_margin.png}
    \caption{Sorted}
  \end{subfigure}
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[scale=0.7]{images/unlabelled_margin2.png}
    \caption{Unsorted}
  \end{subfigure}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[scale=0.7]{images/clique_hist.png}
  \end{subfigure}
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[scale=0.7]{images/kdown_hist.png}
  \end{subfigure}
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[scale=0.7]{images/mcsplit_hist.png}
  \end{subfigure}
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[scale=0.7]{images/mcsplitdown_hist.png}
  \end{subfigure}
...
Since the standard deviations of degrees of both target and pattern graphs are
the most important features and we are mostly choosing between \textsc{McSplit}
and $\textsc{McSplit}\downarrow$ when dealing with unlabelled graphs, we plot
partial dependence plots in... % TODO: continue here
