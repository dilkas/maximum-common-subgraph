...
to be abandoned. % TODO: prove the Theta bound
...
% TODO: add this somewhere 1000 s limit, 512 GB limit (clique becomes impossible for some
%instances), insert CPU specs. kdown now accepts vertex labels. mention how
%many instances were solved by at least one algorithm in each dataset.
...
% TODO: how the data was generated: algorithms * datasets * labelling, etc, hardware
\subsection{Features}
% TODO: feature extractor adopted, formulas for features
