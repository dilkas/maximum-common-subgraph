...
\newtheorem{example}{Example}[chapter] % TODO: what style?
\theoremstyle{remark}
...
The maximum common subgraph problem is a way to determine the similarity between
two graphs. More specifically, it finds what the two graphs have in common
(these ideas will be made more concrete in Section~\ref{sec:definitions}). Since
graphs can represent many real-world phenomena, it is widely used in molecular
science \cite{WCMS:WCMS5, DBLP:journals/dam/GayFMSS14, grindley,
  DBLP:journals/jcamd/RaymondW02a}, malware detection
\cite{DBLP:journals/compsec/ParkRS13}, source code analysis \cite{617051}
% TODO: finish and reword differently

\section{Definitions} \label{sec:definitions}

% TODO: introduce algorithm selection
\begin{definition}
...
% TODO: split into CIS and MCIS
% TODO: state that it is NP-C/-Hard
\begin{definition}
...
% TODO: these should not be subfigures
\begin{figure}
  \centering
...
% TODO: more justification for why we're doing this
