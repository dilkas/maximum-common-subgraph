...
\begin{frame}{\textsc{McSplit}: a Branch and Bound Algorithm}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{overprint}
        Partial solution: \only<3>{\alert{$u_1 \mapsto v_4$}}\only<4-5>{$u_1 \mapsto v_4$}\only<6>{$u_1 \mapsto v_4$, \alert{$u_3 \mapsto v_3$}}\only<7->{$u_1 \mapsto v_4$, $u_3 \mapsto v_3$}
...
%      \visible<2->{\includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{../dissertation/images/both_labels_mcsplitdown_labelling.png}}
%    \end{column}
%    \begin{column}{0.5\textwidth}
%      \centering
%      \includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{../dissertation/images/both_labels_clique_stddeg.png}
%      \visible<2->{\includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{../dissertation/images/both_labels_clique_labelling.png}}
%    \end{column}
%  \end{columns}
%\end{frame}
