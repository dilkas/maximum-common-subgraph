...
Likewise, different implementations of the clique algorithm were combined to
support both the binary format of the ARG Database and the plaintext format of
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[scale=0.5]{images/mcsplit_partial.png}
  \end{subfigure}
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[scale=0.5]{images/clique_partial.png}
  \end{subfigure}
