...
%\begin{definition}
%  An \emph{unsolved \textsc{McSplit} instance} is a partially solved instance
%  $(\textit{future}, M, \textit{incumbent})$ with
%  \[ \textit{future} \]
%  \[ M = \emptyset \]
%\end{definition}
...
% TODO: further work
% filtering variables can help, or coming up with new ones, transformations,
% even lower values of labelling, static labelling (not tied to the size of the graph)
% when is mcsplit better than mcsplit down?
