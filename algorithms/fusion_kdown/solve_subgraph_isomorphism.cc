...
auto main(int argc, char * argv[]) -> int
{
  ...
  try {
    ...
    display_options.add_options()
      ...
      ("vertex-labels",                         "Use vertex labels")
      ("depth",                                 "Depth at which to switch to clique")
      ;
    ...
    params.vertex_labels = options_vars.count("vertex-labels");
    if (options_vars.count("depth"))
      params.depth = options_vars["depth"].as<unsigned>();
